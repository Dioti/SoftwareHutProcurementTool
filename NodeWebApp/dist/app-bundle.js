...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("form", { method: "POST", action: "/submit", onReset: this.handleReset, autoComplete: "off" },
                React.createElement("p", null,
                    React.createElement("label", null, "Forename: "),
                    React.createElement("input", { type: "text", name: "forename", value: this.state.forename, onChange: this.handleInputChange, required: true })),
                React.createElement("p", null,
                ...
                React.createElement("p", null,
                    React.createElement("label", null, "Account Number: "),
                    React.createElement("input", { type: "text", name: "accNo", value: this.state.accNo, onChange: this.handleInputChange, minLength: "8", maxLength: "8", required: true })),
                React.createElement("p", null,
                    React.createElement("label", null, "Supplier: "),
                    React.createElement("input", { type: "text", name: "supplier", value: this.state.supplier, onChange: this.handleInputChange, required: true })),
                React.createElement("p", null,
                    React.createElement("label", null, "Description: "),
                    React.createElement("textarea", { rows: "5", name: "desc", value: this.state.desc, onChange: this.handleInputChange })),
                React.createElement("p", null,
                    React.createElement("label", null, "Quantity: "),
                    React.createElement("input", { type: "number", min: "1", name: "quantity", value: this.state.quantity, onChange: this.handleInputChange, required: true })),
                React.createElement("p", null,
                    React.createElement("label", null, "Estimated cost(\u00A3): "),
                    React.createElement("input", { type: "number", min: "0", name: "estCost", step: "0.01", value: this.state.estCost, onChange: this.handleInputChange, required: true })),
